...
- Added "MM Show Brand All screen px width" gear icon toggle switch & also "MM Brand Name Dont Show Under px" gear icon slider that appears if "MM Show Brand All screen px width" options not selected. This allows the optioon of only showing the brand name above a certian configured screen px width. 
